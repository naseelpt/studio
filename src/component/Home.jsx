        ...
        <Element name='sect1'>
                ...
                <div className='md:mt-20 mt-10'>
                    ...
                    <div className='mt-10 '>
                        ...
                        <p className='text-xl xl:px-52 px-2 ms-5 mt-8 text-white'>Transform your creative visions into tangible designs with Creative Fabrica's Studio — a space crafted specifically for innovators like you. Dive into the boundless possibilities with Studio, offering you unrestricted access to our extensive collection of millions of assets, ready to bring your ideas to life</p>
